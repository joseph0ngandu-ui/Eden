...
class MT5Installer(QDialog if PYSIDE6_AVAILABLE else object):
    ...
    def on_download_complete(self, installer_path: str):
        ...
        try:
            ...
            self.status_label.setText("MetaTrader 5 installer launched. Please complete the installation.")
                ...
                for chunk in response.iter_content(chunk_size=8192):
                    if chunk:
                        ...
                        if total_size > 0:
                            ...
                            if PYSIDE6_AVAILABLE:
                                self.progress_updated.emit(percentage, f"Downloading... {downloaded // 1024}KB / {total_size // 1024}KB")
...
def mt5_fetch_ohlcv(symbol: str, timeframe: str, start: str, end: str):
    ...
    try:
        ...
        for src, dst in [('open','open'),('high','high'),('low','low'),('close','close'),('tick_volume','volume'),('real_volume','volume')]:
...
class MT5Manager:
    ...
    def prompt_mt5_installation(self, parent=None) -> bool:
        ...
        if not PYSIDE6_AVAILABLE:
            print("MetaTrader 5 not found. Please install it manually from https://www.metatrader5.com/")
            return False
